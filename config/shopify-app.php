...
return [
    ...
    */
    ...
    'webhooks' => [
            ...
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS',  env('SHOPIFY_APP_URL'). '/webhook/orders-create')
            ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'app/uninstalled'),
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS',  env('SHOPIFY_APP_URL'). '/webhook/app-uninstalled')
            ],
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('SHOPIFY_APP_URL').'/js-method-response'),
